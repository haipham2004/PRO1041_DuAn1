...
//        setDataToChart(panelTKDT);
    ...
    public void setDataToChart(JPanel panelHoaDon) {
        ...
        if (txtNgayBD.getCalendar() == null || txtNgayKT.getCalendar() == null) {
            ...
            try {
                ...
                final File file1 = new File("ChartTKDT.png");
    ...
    private void initComponents() {
        ...
        jToggleButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/pdf.png"))); // NOI18N
        jToggleButton5.setText("Xuất PDF");

        jToggleButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/new (1).png"))); // NOI18N
